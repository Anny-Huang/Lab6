...
//  Define variables to hold initial values for modelName and duration
let modelName = "XYZ"; 
let duration = 0;
...
//Function for changing the model name between "XYZ" and "CPRG", and recalculating the total cost accordingly
function changeModel() {
 ...
 // Attach the changeModel function to the "Switch Model" button click event
 modelButton.addEventListener("click", changeModel);
...
function changeDuration(){
 ...
 // Attach the changeDuration function to the durationButton click event
